 ...
 * @author Juan
 */
public class EstudianteForm extends Crud {

    private static final long serialVersionUID = 1L;

    private String numeroDocumento, nombres, nombreMateria, semestre;
    ...
    public EstudianteForm() {
        ...
        jTextField3.setBorder(BorderFactory.createLineBorder(c));
        jTextField3.addKeyListener(new KeyAdapter() {//Este campo es de solo numeros y por lo tanto no es permitido caractenes A-Z, se bloquea el teclado numerico para que el usuario no pueda ingresar letras
            @Override
            public void keyTyped(KeyEvent e) {
                char c;
                c = e.getKeyChar();
    ...
    public void Guardar() {
        if (ValidarCampos() == true) {
            estudiante = UM.buscarEstudiante(numeroDocumento);
            if (estudiante.getNumeroDocumento().equals(numeroDocumento)) {
                JOptionPane.showMessageDialog(this, "El Profesor ya existe en el sistema", "Error", JOptionPane.INFORMATION_MESSAGE);
            } else {
                UM.crearEstudiante(numeroDocumento, nombres, Integer.parseInt(semestre));
                if (estudiante.getNumeroDocumento().equals(numeroDocumento)) {
                    JOptionPane.showMessageDialog(this, "El Estudiante ha sido guardadó", "Operación exitosa", JOptionPane.INFORMATION_MESSAGE);
                    Limpiar();
                }
            }
        }
    ...
    public void Buscar() {
        numeroDocumento = jTextField1.getText();
        if(numeroDocumento.equals("") || numeroDocumento.isEmpty() || numeroDocumento == null){
            JOptionPane.showMessageDialog(this, "El campo numero de documento es obligatorio", "Campo numero documento (Obligatorio)", JOptionPane.ERROR_MESSAGE, icoError);
            jTextField1.isFocusable();
        } else {
            estudiante = UM.buscarEstudiante(numeroDocumento);
            jTextField1.setText(estudiante.getNumeroDocumento());
            jTextField2.setText(estudiante.getNombre());
            jTextField3.setText(String.valueOf(estudiante.getSemestre()));
        }
    }
    ...
    public void Eliminar() {
        ...
        if(numeroDocumento.equals("") || numeroDocumento.isEmpty() || numeroDocumento == null){
            ...
            UM.eliminarEstudiante(estudiante);
        }
    }
